...
func main() {
	if len(os.Args) != 4 {
		fmt.Fprintln(os.Stderr, "usage: node-runtime-unit OPERATION ARTIFACT_SHA256 RELEASE_DIRECTORY")
		os.Exit(1)
	}
	unit, err := nodelaunch.Render(nodelaunch.Assignment{UID: 60000, OperationID: os.Args[1], ProjectID: strings.Repeat("8", 64), RuntimeID: strings.Repeat("7", 64), ArtifactSHA256: os.Args[2], ToolchainSHA256: "5f4ddab610c1ab2016b3c227cebdbf6d9495161487e4739c7b90090595f465f7", Architecture: "arm64", ReleaseDirectory: os.Args[3], Port: 31877})
	if err != nil {
